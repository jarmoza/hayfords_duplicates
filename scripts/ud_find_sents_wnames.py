...
def main():
    ...
    queequeg_groups = []
    groups_to_sentences = {}
    with open(project_path + pmf_output_folder + pmf_output_file, "r") as pmf_file:
